"""Build the Hugging Face Space bundle (demo mode: DuckDB + SQLite, no database server).

Run locally (needs your PostgreSQL with olist, olist_lab and indexed documents):
    python -m deploy.build_demo

Produces dist/hf_space/, ready to upload to a Docker Space:
...
pinned: false
license: mit
short_description: AI analyst that finds why a business metric changed
---
...
takes 1-3 minutes. Source code, tests and benchmark: see the GitHub repository.
"""
